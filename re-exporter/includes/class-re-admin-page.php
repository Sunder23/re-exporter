...
class Admin_Page {
	...
	public function get_settings_data() {
		...
		return array(
			...
			'tax_terms'         => $tax_terms,
			'shared_field_definitions' => $this->settings->global_settings()->get_shared_field_definitions(),
			'shared_field_map'         => $this->settings->global_settings()->get_shared_field_map(),
			...
			'olx_field_map_raw' => $this->settings->olx()->get_field_map_overrides(),
			'olx_value_map'      => $this->settings->olx()->get_value_map(),
			'olx_city_label_map' => $this->settings->olx()->get_city_label_map(),
			'olx_shared_targets' => $this->settings->get_shared_targets_for_platform( 'olx' ),
			...
			'alo_field_map_raw'      => $this->settings->alo()->get_field_map_overrides(),
			'alo_value_map'          => $this->settings->alo()->get_value_map(),
			'alo_shared_targets'     => $this->settings->get_shared_targets_for_platform( 'alo' ),
		...
		'alo_contacts'               => $this->settings->alo()->get_contacts(),
			...
			'imoti_field_map_raw'        => $this->settings->imoti()->get_field_map_overrides(),
			'imoti_value_map'            => $this->settings->imoti()->get_value_map(),
			'imoti_shared_targets'       => $this->settings->get_shared_targets_for_platform( 'imoti' ),
			...
			'realistimo_field_map_raw'       => $this->settings->realistimo()->get_field_map_overrides(),
			'realistimo_value_map'           => $this->settings->realistimo()->get_value_map(),
			'realistimo_shared_targets'      => $this->settings->get_shared_targets_for_platform( 'realistimo' ),
